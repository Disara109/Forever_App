        ...
        {paddingTop: 16 }}>
          ...
          {!user ? (
            ...
            <View className='items-center w-full'>
              ...
              <Text className='text-secondry text-base mb-8 text-center w-3/4 px-4'>
              Log in to view your profile, orders and addresses.
              </Text>
              <TouchableOpacity onPress={()=> router.push('/(auth)/sign-in')} className='bg-primary w-3/5 py-3 
              rounded-full items-center shadow-lg'>
            ...
            <View className='items-center mb-8'>
              <View className='relative'>
                ...
                <Text className='text-secondry text-sm'>{user.emailAddresses[0].emailAddress}</Text>
