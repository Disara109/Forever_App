        ...
        <SafeAreaView className='flex-1 bg-surface' edges={['top']}>
            ...
            <View className='flex-row gap-2 mb-3 mx-4 my-2'>
                ...
                <View className='flex-1 flex-row items-center bg-white rounded-xl border border-gray-100'>
                    ...
                    <TextInput className='flex-1 ml-2 text-primary px-4 py-3' placeholder='Search products...' 
                    returnKeyType='search' placeholderTextColor={COLORS.secondary} />
                </View>

                {/* Filter Button */}
                <TouchableOpacity bg-gray-800 w-12 h-12 items-center justify-center rounded-xl>
            ...
            {loading ? (
                <View className='flex-1 justify-center'>
                    ...
                    <FlatList data={products} keyExtractor={(item)=> item._id} numColumns={2} 
                    contentContainerStyle={{padding: 16, paddingBottom: 100}} columnWrapperStyle={{ justifyContent: 'space-between'}}
